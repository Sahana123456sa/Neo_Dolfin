...
| Muhammad Saad Saad |               |
| Nick Lane |               |
| Pradipta Dutta | <li> Conducted market research on finance management and highlighted on key areas to focus for building a financial well-being application. Documented research findings into a report. </li><li> Built a savings prediction model using a combination of ARIMA and RF and created a pull request. </li><li> Took up some leadership roles and as a code reviewer for DS/AI stream to review codes and approve the request. </li><li> Did study on functionalities potentially useful for the project and conveyed my idea to team lead. </li> <li> I have taken leadership role and I am currently assisting team lead on certain tasks and also reviewing codes on GitHub. </li><li> I am also reviewing codes and merging them to the main repository, I am also helping juniors to clear their doubts about the project. </li><li> I am helping few juniors with GitHub and guiding them thoroughly with commits and pull request. </li> |
| Ricky Boeing |               |
| Sagar Gupta |               |
| Sahana Gollapalli |               |
...
| Sahana Gollapalli | Write contributions here ! <li>Redeveloped the profile route code, ensuring seamless integration with existing functions and enhancing overall performance and maintainability.</li><li>Successfully redeveloped the code without using SQL queries, utilizing the transaction.apply method to streamline operations and improve data handling efficiency.</li><li>Pushed the updated profile route code to GitHub after thorough testing, ensuring robust functionality and code quality through comprehensive test cases and peer reviews.</li><li>Checked the website after uploading the updated profile route code, thoroughly testing the functionality to ensure all features were working as intended. Confirmed the successful deployment with no issues detected.</li><li>Noticed that the website was not displaying any values due to the database being empty, indicating that the code was correctly integrated but required populated data to showcase results.</li><li>Began working on the email notification system, concentrating on backend integration to facilitate the sending and retrieving of emails from the database, enhancing user communication and system interactivity.</li><li>Collaborated closely with Junkai and Gimsara, leveraging senior permissions for backend development to ensure alignment with project goals and adherence to best practices.</li><li>Initially participated in data cleaning efforts, meticulously analyzing data quality and consistency. Later shifted focus to data generation as it was deemed more critical for this semester's objectives.</li>li>Researched data generation methods for alternative data sources and adapted to changing project objectives by initiating meetings with leadership to understand current directives and deliverables, ensuring alignment with overall project strategy.</li><li>Proposed the inclusion of retirement savings in user profiles for improved savings prediction models. After thorough evaluation, the proposal was ultimately denied due to viability concerns, demonstrating adaptability and willingness to pivot based on project needs.</li><li>Attended regular team meetings, actively observing and participating in discussions to stay informed about project progress, challenges, and upcoming tasks.</li><li>Upskilled myself on Python, focusing on practical applications and hands-on coding to enhance my contributions to the project and improve overall efficiency in handling backend development tasks.</li> |
...
| Liny Jose Alias | <li>Generated Bank Transaction Dataset using python for four users spanning two years with more than 2800 entries including transaction categories in detail.</li><li>Generated Home Loan Dataset using Python showing including loan repayments for two different users for a period of two years</li><li>Generated Credit Card Dataset including transaction descriptions for two different users for a period of two years</li><li>Created a model looking at payment problems including arrears, dishonor fees, over-limit fees, late fees, payday loans also assigning a score to the user.</li><li>Generated Dataset with payment problems including negative balances to test the model.</li><li>Be a part of the Data Quality Validation team and Established validation rules for Dataset variables to ensure Data Integrity.</li><li>Back End-Fixed the News Page Route and directed the Read More Button to the accurate article page which was broken earlier.</li><li>Created pull requests for all the above contributions, received approval and merged to develop.</li> |
...
| Pradipta Dutta | <li> Studied the pdf file from University of Melbourne that consisted of R code for generating financial data related to their age. </li><li> I undertook the task of reading and understanding the R code and replicate it into a python script. </li><li> I executed my own research to understand and learn about spine regression function and used the concept to build a python script for age-norm data generation. </li><li> Created a python script that visualizes the predicted savings of individual users and also plots  the month of the highest savings along with a hover functionality that shows the value of the predicted savings when the cursor is hovered over. </li><li> I also added a user selection option that allows finance visualization of the selected user only.  </li><li> Helped juniors by clarifying their doubts with the project and its various components. </li><li> Updated juniors with company goals and objectives when asked for help. </li><li> Assisted team members with their technical issues, guided them by explaining stepwise process for better understanding. </li> |
